...
void Server::handleNewConnection()
{
    ...
    connect(clientHandler, &QThread::finished, clientHandler, &QObject::deleteLater);
...
// void Server::handleGetCourses(QTcpSocket *clientSocket)
// {
//     QFile file("courses.json");
//     if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
//         QJsonObject errorMessage;
...
// void Server::handleStudentEnrollInCourse(QTcpSocket *clientSocket, const QJsonObject &request)
// {
...
// void Server::handleGetRegisteredCourses(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString studentUsername = request["student_username"].toString();
...
// void Server::handleGetExamQuestion(QTcpSocket *clientSocket, const QJsonObject &request)
// {
...
// void Server::handleSubmitExamAnswer(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString courseKey = request["course_key"].toString();
//     QString studentUsername = request["student_username"].toString();
...
// void Server::handleGetHomework(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString courseKey = request["course_key"].toString();
...
// void Server::handleSubmitHomeWorkAnswer(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString courseKey = request["course_key"].toString();
//     QString studentUsername = request["student_username"].toString();
//     QString answer = request["answer"].toString();
...
// void Server::handleGetContent(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString courseKey = request["course_key"].toString();
...
// void Server::handleGetStudentGrade(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString courseKey = request["course_key"].toString();
//     QString studentUsername = request["student_username"].toString();
...
// void Server::handleRemoveStudentFromCourse(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString courseKey = request["course_key"].toString();
//     QString studentUsername = request["student_username"].toString();
...
// void Server::handleGetParticipants(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString courseKey = request["course_key"].toString();
...
// void Server::handleSetStudentGrade(QTcpSocket *clientSocket, const QJsonObject &request)
// {
//     QString courseKey = request["course_key"].toString();
//     QString studentUsername = request["student_username"].toString();
