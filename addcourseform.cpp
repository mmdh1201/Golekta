    ...
    if (socket->waitForConnected(3000)) {
        ...
        if (socket->waitForReadyRead(3000)) {
            ...
            if (messageType == "error") {
                ...
                ui->courseCapacityLineEdit->clear();
                ui->courseDaysLineEdit->clear();
                ui->courseFinalDateLineEdit->clear();
                ui->courseGroupLineEdit->clear();
                ui->courseLocationLineEdit->clear();
                ui->courseNameLineEdit->clear();
                ui->unitsLineEdit->clear();
                ui->courseMasterComboBox->clear();
                ui->courseTimeLineEdit->clear();
                ui->courseNumberLineEdit->clear();
                loadInstructors();
            }
        }
